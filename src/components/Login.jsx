...
export default function LoginForm() {
  ...
  return (
        <main className="w-full h-screen flex flex-col items-center justify-center px-4">
            <div className="max-w-sm w-full border p-10 rounded-3xl w-min-90% text-gray-600 space-y-8">
                <div className="text-center">
                  <h1 className="text-5xl font-bold tracking-tight"
            style={{ fontFamily: "var(--font-secondary)" }}>BrainDump</h1>
                    <div className="mt-10 space-y-1">
                        <h2 className="text-gray-800 text-2xl font-bold sm:text-3xl">Log in to your account</h2>
                ...
                <div className="space-y-4 text-sm font-medium">
                    <button className="w-full font-bold flex items-center justify-center gap-x-3 py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100">
                    ...
                    <button className="w-full flex items-center justify-center gap-x-3 py-2.5 border rounded-lg hover:bg-gray-50 duration-150 font-bold active:bg-gray-100">
                        <svg className="w-5 h-5" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M95.8 12H110L72.6 56.8L117 108H82.4L55.8 76.1L25.7 108H11.2L51.1 60.3L7 12H42.5L67.1 41.4L95.8 12ZM89.5 100H98.6L35 19.4H25.2L89.5 100Z" fill="currentColor"/>
</svg>

                        Continue with X
                    </button>
                    <button className="w-full flex font-bold items-center justify-center gap-x-3 py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100">
                        <svg className="w-5 h-5" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
